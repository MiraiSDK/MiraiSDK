...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.layer.backgroundColor = CGColorCreateGenericRGB(1, 0, 0, 1);
    UILabel *label = [[UILabel alloc] init];
    label.frame = CGRectMake(20, 20, 500, 500);
    label.layer.backgroundColor = CGColorCreateGenericRGB(0, 1, 0, 1);
    label.text = [NSString stringWithFormat:@"Hello World"];
    [self.window addSubview:label];
    
    TNCustomView *custom = [[TNCustomView alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
